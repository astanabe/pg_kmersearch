...
-- 2. Execute kmersearch_parallel_highfreq_kmer_cache_load()
SELECT '2. High-frequency k-mer parallel cache load:' as step;
...
-- 5. Execute kmersearch_parallel_highfreq_kmer_cache_free()
SELECT '5. High-frequency k-mer parallel cache release:' as step;
